    ...
    <div className="relative h-full w-full bg-slate-900">
      ...
      >
        <div className="relative flex h-full w-full overflow-hidden">
          <div
            className={`relative shrink-0 h-full flex-col border-r border-white/10 overflow-hidden transition-all duration-300 ease-in-out bg-slate-950/40 ${
          ...
          <button
            ...
            className={`absolute top-7 z-20 flex h-6 w-6 items-center justify-center border border-white/10 bg-slate-800 text-slate-400 shadow-lg shadow-black/30 hover:text-white transition-all duration-300 ${
              isFileTreeOpen
                ? "rounded-full"
