...
export function ThoughtChain({ thoughts }: ThoughtChainProps) {
  ...
  return (
    <div className="flex flex-col gap-3 p-3 bg-slate-800/60 rounded-lg border border-white/10 max-w-full shadow-lg shadow-black/10">
      {/* 流程类型标识 */}
      {currentFlow && (
          ...
          <div key={thought.key}>
            <div className="flex gap-3 items-start">
              <div className="mt-0.5 relative">
                ...
                {!isLast && (
                  <div
                    className="absolute top-5 left-2 w-px h-full bg-white/10 -z-10"
              ...
              <div className="flex flex-col gap-1 flex-1">
                ...
                {isHistory ? (
                  <>
                    <div
                      className="flex items-center gap-2 cursor-pointer hover:bg-white/8 -mx-2 px-2 py-1 rounded transition-colors"
                    ...
                    >
                      ...
                      <span className="text-xs px-2 py-0.5 rounded-full bg-white/8 text-slate-400">
                  ...
                  <>
                    <span
                      className={`text-sm font-medium ${thought.status === "pending" ? "text-blue-300" : "text-slate-300"}`}
                    >
                      {thought.title}
                    </span>
                    {thought.description && (
