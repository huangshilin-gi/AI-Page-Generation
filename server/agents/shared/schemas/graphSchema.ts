...
// Image Analysis 阶段的 Schema（Vision 模型输出）
import { ImageAnalysisSchema } from "../../flows/traditional/image-analysis/schemas/imageAnalysisSchema.js";
...
export const GraphSchema = z.object({
  ...
  // step-1: 设计稿视觉分析（Qwen-VL 输出，仅图片输入时存在）
